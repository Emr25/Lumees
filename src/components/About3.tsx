        ...
        <section className="bg-stone-700 py-20 px-6">
            <div className="max-w-5xl mx-auto">
                ...
                <p className="text-white text-3xl leading-loose uppercase tracking-wide text-left">
                    We’re on a mission to bring intelligent systems closer to everyone — whether through lightweight on-device models or large-scale assistants that reason, remember, and communicate naturally. With more models, more modalities, and more access points on the way, Lumees is building for the next era of human-machine collaboration.
                </p>
            </div>
        </section>
    )
